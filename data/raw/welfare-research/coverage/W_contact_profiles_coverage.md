...
- Own websites crawled: 680 across all databases ({'values found on three or more websites (not used)': 1, 'readable': 573, 'unreadable': 99, 'robots_disallowed': 8, 'readable, crawled with robots.txt unreachable (flagged)': 2}); explicit robots.txt Disallow rules honoured, one request at a time per site, 1.5 s apart. A site whose robots.txt could not be read (server, network or certificate error) was crawled anyway and flagged.
- Welfare organisations for which the research found a published email or phone: 170 of 497; with named people found: 115; named people recorded: 347 (at most six new per organisation, most senior first).
